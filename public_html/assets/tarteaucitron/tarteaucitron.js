    ...
    "load": function () {
        ...
        var cdn = tarteaucitron.cdn,
            ...
            defaults = {
                ...
                "cookieName": 'Gestionnaire de cookies',
                "highPrivacy": false,
                "orientation": "top",
                "removeCredit": false,
                "showAlertSmall": true,
          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addScript(pathToServices, '', function () {
                ...
                for (i = 0; i < cat.length; i += 1) {
                    ...
                    html += '               <button id="button_api" onclick=";tarteaucitron.userInterface.toggle(\'tarteaucitronDetails' + cat[i] + '\', \'tarteaucitronInfoBox\');return false">&#10011; ' + tarteaucitron.lang[cat[i]].title + '</button>';
                    html += '            </div>';
